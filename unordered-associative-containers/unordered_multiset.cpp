...
int main()
{
    ...
    unordered_multiset<int> ranks3{10, 5, 5, 4, 2, 2, 1, 20};

    print("unorderd multiset", ranks3);
...
/*** Capacity ***/
int Capacity() {
    unordered_multiset<int> ranks = {10, 5, 5, 4, 2, 2, 3, 3, 1, 20};
    print("unordered_multiset values", ranks);
...
int BucketInterface() {
    ...
    cout << "Elements in 3rd index Buckets: ";
    for (auto itr = ranks.begin(3); itr != ranks.end(3); itr++)
    {
        cout << *itr << ", ";
    }
    cout << endl;
